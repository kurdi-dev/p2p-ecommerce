...
export class ProductControllerBase {
  ...
  @common.Get("/:id/featuredProducts")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "read",
    possession: "any",
  ...
  async findManyFeaturedProducts(
    @common.Req() request: Request,
    @common.Param() params: ProductWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<FeaturedProduct[]> {
    const query = plainToClass(FeaturedProductFindManyArgs, request.query);
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
    ...
    const results = await this.service.findFeaturedProducts(params.id, {
      ...query,
      select: {
        createdAt: true,
        endDate: true,
  ...
  @common.Post("/:id/featuredProducts")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "update",
    possession: "any",
  ...
  @common.Patch("/:id/featuredProducts")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "update",
    possession: "any",
  ...
  async updateFeaturedProducts(
    @common.Param() params: ProductWhereUniqueInput,
    @common.Body() body: FeaturedProductWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
    const data = {
      featuredProducts: {
  ...
  @common.Delete("/:id/featuredProducts")
  @nestAccessControl.UseRoles({
    resource: "Product",
    action: "update",
    possession: "any",
