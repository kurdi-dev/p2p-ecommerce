...
@ArgsType()
class UpdateFeaturedProductArgs {
  @Field(() => FeaturedProductWhereUniqueInput, { nullable: false })
  where!: FeaturedProductWhereUniqueInput;
  @Field(() => FeaturedProductUpdateInput, { nullable: false })
  data!: FeaturedProductUpdateInput;
}

export { UpdateFeaturedProductArgs };
